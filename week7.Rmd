...
```{r}
xtra_tidy_us = pivot_longer(us, c(cases, cases_avg, cases_per_100k, cases_avg_per_100k, deaths, deaths_per_100k, deaths_avg, deaths_avg_per_100k), names_to = "statistic", values_to = "value")
```
...
```{r}
ky_wv_tn_plot = ky_wv_tn_cases_aug_sept_2021 %>% 
