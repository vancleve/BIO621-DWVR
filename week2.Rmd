...
2. Try plotting the cases for Kentucky. You'll notice immediately these are *cumulative* cases over the whole pandemic.

```{r}
plot(us_cases[["date"]], us_cases[["Kentucky"]], type='l')
```

3. Write a function that has the following four arguments and plots the `voters` data between two dates:
